$(function () {
     ...
     */
    var lstMenu = [
        { pUrl: '/ReportProfile/Index', cUrl: '/ReportProfile/ReportProcess' }
        , { pUrl: '/ReportProfile/Index', cUrl: '/ReportProfile/ReportDetail' }
        , { pUrl: '/ReportProfile/Index', cUrl: '/ReportProfile/UpdateProfileView' }
        ...
        , { pUrl: '/Document/Index', cUrl: '/Document/CreateDocument' }
        , { pUrl: '/Document/Index', cUrl: '/Document/UpdateDocument' }
    ]; 
