$(document).ready(function () {
    ...
    */
    ...
    navListItems.click(function (e) {
        e.preventDefault();
        $('#divStep a').each(function () {
            $(this).removeClass('btn-success-focus');
        });
        var $target = $($(this).attr('href')),
            $item = $(this);

        if (!$item.hasClass('disabled')) {
            $item.removeClass('btn-default').addClass('btn-success-focus');
    ...
    */
    ...
    allNextBtn.click(function () {
        var curStep = $(this).closest(".setup-content"),
            ...
            isValid = true;
        //nextStepWizard.removeClass('btn-default').addClass('btn-success');
    ...
    allBackBtn.click(function () {
        ...
        if (isValid) {
            curStepWizard.removeClass('btn-success').addClass('btn-default').addClass('disabled');
            //Progress to the next page.
