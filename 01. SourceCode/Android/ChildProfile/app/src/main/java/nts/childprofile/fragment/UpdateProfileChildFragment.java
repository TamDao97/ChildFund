 ...
 */
public class UpdateProfileChildFragment extends Fragment {
    private View view;
    ...
    private String imageLink = "", childProfilesId = "", imageSignatureLink = "";
    ...
    private RecyclerView recyclerViewSubject, recyclerLeaningCapacity, recyclerHouseWork, recyclerHealth,
            recyclerPersonality, recyclerHobbie, recyclerDream;
    private CheckListAdapter checkListSubjectAdapter, checkListCapacityAdapter, checkListHouseWorkAdapter,
            checkListPersonalityAdapter, checkListHobbieAdapter, checkListDreamAdapter;
    private CheckInputListAdapter checkListHealthAdapter;
    ...
    //Component step 4
    private RecyclerView recyclerNumberPet, recyclerTypeHousing, recyclerRoofMaterial, recyclerWallMaterials, recyclerFloorMaterials, recyclerIsElectricity, recyclerSchoolMet,
            recyclerClinicsMet, recyclerWaterSourceMet, recyclerWaterFrom, recyclerRoadConditions, recyclerHarvestOutput, recyclerIncomeOther;
    ...
    private CheckInputListAdapter checkListIncomeOtherAdapter, checkListHarvestOutput, checkListNumberPetAdapter;
    private TextInputListAdapter textListHarvestOutputAdapter;
    ...
    private LinearLayout lyt_consent_step5;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_update_profile_child, container, false);

        Toolbar mToolbar = (Toolbar) getActivity().findViewById(R.id.toolbar);
        TextView toolbarTitle = mToolbar.findViewById(R.id.toolbar_title);
        TextView txtOffline = mToolbar.findViewById(R.id.txtOffline);
        toolbarTitle.setText("Cập nhật hồ sơ trẻ/RAM updates");
        ...
        if (bundle != null) {
            childProfilesId = bundle.getString("Id", "");
        }
        ...
        //Hiển thị thông tin Spinners
        viewDataSpinners();

        //Hiển thị thông tin lên giao diện
        if (childProfilesId.equals(Constants.DraftUpdate)) {
        ...
        lyt_consent_step5 = step5.findViewById(R.id.lyt_parent);
//        if (global.isStatusRunApp()) {
//            if (childProfileModel.TypeChildProfile.equals(Constants.TYPE_CHILDPROFILE_SQLITE_DOWNLOAD) || childProfileModel.TypeChildProfile.equals(Constants.TYPE_CHILDPROFILE_SQLITE_UPDATED)) {
//                lyt_consent_step5.setVisibility(View.GONE);
//            }
//        }
        ...
        try {
            if (childProfileModel.ImagePath != null && !childProfileModel.ImagePath.isEmpty()) {
                if (childProfileModel.ImagePath.contains("http")) {
                    ...
                    imageLink = childProfileModel.ImagePath;
                }
            } else {
...
//            txtDateOfBirth.setText(childProfileModel.DateOfBirth);
            ...
            checkListSubjectAdapter = new CheckListAdapter(getActivity(), childProfileModel.FavouriteSubjectModel.ListObject);
            recyclerViewSubject.setAdapter(checkListSubjectAdapter);
            checkListSubjectAdapter.SetOnItemClickListener(new CheckListAdapter.OnItemClickListener() {
                @Override
            ...
            checkListPersonalityAdapter = new CheckListAdapter(getActivity(), childProfileModel.PersonalityModel.ListObject);
            recyclerPersonality.setAdapter(checkListPersonalityAdapter);
            checkListPersonalityAdapter.SetOnItemClickListener(new CheckListAdapter.OnItemClickListener() {
                @Override
                public void onItemClick(View view, int position, ObjectInputModel obj) {
                    CheckBox checkBox = (CheckBox) view;
    ...
    private void initComponent() {
        ...
        imageAvata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String urlImage = (imageLink != null && imageLink != "") ? imageLink : childProfileModel.ImagePath;
        ...
        spnProgramCode = step1.findViewById(R.id.spnProgramCode);
        ...
        spnPrimarySchoolClass = step2.findViewById(R.id.spnPrimarySchoolClass);
        spnSecondarySchoolClass = step2.findViewById(R.id.spnSecondarySchoolClass);
...
//                        spnSecondarySchoolClass.callOnClick();
        ...
        recyclerPersonality = (RecyclerView) step2.findViewById(R.id.recyclerPersonality);
        recyclerPersonality.setLayoutManager(new GridLayoutManager(getActivity(), 2));
        recyclerPersonality.setHasFixedSize(true);
        recyclerPersonality.addItemDecoration(new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL_LIST));
...
//        txtPet = step4.findViewById(R.id.txtPet);
...
//                });
    ...
    public void backListProfile() {
        new AlertDialog.Builder(getActivity())
                .setMessage("Bạn có muốn thoát khỏi chức năng Cập nhật hồ sơ này/Exit?")
                .setCancelable(false)
...
//        GetInfoStep5();
        ...
        editor.putString(Constants.Key_Data_Profile_Draft_Update, new Gson().toJson(childProfileModel));
        editor.apply();
    }
...
//        }
        ...
        try {
            ...
            Toast.makeText(getActivity(), "Cập nhật hồ sơ trẻ thành công!", Toast.LENGTH_SHORT).show();
            backProfileList();
            SharedPreferences.Editor editor = sharedPreferencesDataFix.edit();
            ...
            Toast.makeText(getActivity(), "Cập nhật hồ sơ trẻ không thành công!", Toast.LENGTH_SHORT).show();
            progressDialog.setVisibility(View.GONE);
        }

    }

    ///Lưu thông tin hồ sơ online
...
//        if (childProfileModel.OrderNumber == null) {
...
//        }
        ...
        txtConsentVillage.setText(spnVillage.getText().toString());
...
//        if (txtOrderNumber.getText() == null || txtOrderNumber.getText().toString().isEmpty()) {
//            childProfileModel.OrderNumber = null;
//        } else {
//            try {
//                childProfileModel.OrderNumber = Integer.parseInt(txtOrderNumber.getText().toString());
//            } catch (Exception ex) {
//                Toast.makeText(getActivity(), "Số thứ tự trẻ nhập vào phải là một số.", Toast.LENGTH_SHORT).show();
//                txtOrderNumber.findFocus();
//            }
//        }
...
//        childProfileModel.NumberPet = txtPet.getText().toString();
    ...
    private void viewProfileChild() {
        progressDialog.setVisibility(View.VISIBLE);
        AndroidNetworking.get(Utils.GetUrlApi("api/ChildProfiles/GetInfoChildProfile?id=" + childProfilesId))
                .setPriority(Priority.MEDIUM)
                .build()
    ...
    private void getProfileOffline() {
        DataBaseHelper dataBaseHelper = new DataBaseHelper(getActivity(), Constants.DATABASE_NAME, null, 1);
        childProfileModel = dataBaseHelper.getInfoChildProfile(childProfilesId);
        setInfoProfileChild();
    ...
    private void setInfoProfileChild() {
        ...
        try {
            ...
            if (childProfileModel.ImagePath != null && childProfileModel.ImagePath != "" && !childProfileModel.ImagePath.isEmpty()) {
                if (global.isStatusRunApp()) {
                    File file = new File(childProfileModel.ImagePath);
                    Uri uri = Uri.fromFile(file);
                    imageAvata.setImageURI(uri);
        ...
        try {
            ...
            txtChildCode.setText(childProfileModel.ChildCode);
            setDataSchool(childProfileModel.WardId, childProfileModel.SchoolId);
            if (childProfileModel.SchoolId != null) {
                if (childProfileModel.SchoolId.equals("Other")) {
                    lySchoolOtherName.setVisibility(View.VISIBLE);
                } else {
                    lySchoolOtherName.setVisibility(View.GONE);
...
//                                Toast.makeText(getActivity(), "Trong danh sách gia đình Mẹ/Mother sống cùng trẻ", Toast.LENGTH_LONG).show();
            ...
            txtRoadConditionsOther.setText(childProfileModel.RoadConditionModel.OtherValue);
            spnFamilyType.setText(childProfileModel.FamilyType);
//            txtPet.setText(childProfileModel.NumberPet);
            //txtIncomeSources.setText(childProfileModel.IncomeSources);
...
////            });
            ...
            //Step 5
            try {
                if (childProfileModel.ImageSignaturePath != null && !childProfileModel.ImageSignaturePath.isEmpty()) {
                    if (global.isStatusRunApp()) {
                        File file = new File(childProfileModel.ImageSignaturePath);
                        Uri uri = Uri.fromFile(file);
                        imageSignature.setImageURI(uri);
                    } else {
                        Picasso.with(getContext()).load(childProfileModel.ImageSignaturePath).into(imageSignature);
                    }
                } else {
                    Picasso.with(this.getContext()).load(R.drawable.ic_people).resize(300, 300)
                            .centerInside().into(imageSignature);
                }
            } catch (Exception ex) {
            }
            txtConsentName.setText(childProfileModel.ConsentName);
            spnConsentRelationship.setText(childProfileModel.ConsentRelationship);
            if (childProfileModel.ConsentVillage != null) {
                txtConsentVillage.setText(childProfileModel.ConsentVillage);
            }
//            else {
//                txtConsentVillage.setText(spnDistrict.getText().toString());
//            }
            if (childProfileModel.ConsentWard != null) {
                txtConsentWard.setText(childProfileModel.ConsentWard);
            } else {
                txtConsentWard.setText(spnWard.getText().toString());
            }
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    if (spnRelationship.getTag().equals(Constants.FAMILY_RELATIONSHIP_MOTHER)) {
                        for (FamilyMemberModel item : childProfileModel.ListFamilyMember) {
                    ...
                    if (familyInfoModel.Position != null) {
                        ...
                        childProfileModel.ListFamilyMember.get(familyInfoModel.Position).JobOtherName = familyInfoModel.JobOtherName;
    ...
    private void countSisterAndBrother() {
        ...
        txtTotalSisters.setText("Tổng số anh/ em trai ruột của trẻ/ Number of brothers: "+String.valueOf(countSister));
        txtTotalBrothers.setText("Tổng số chị/ em gái ruột của trẻ/ Number of sisters: "+ String.valueOf(countBrother));
    }

    private void backProfileList() {
        Fragment fragment = new ProfileListFragment();
        Utils.ChangeFragment(getActivity(), fragment, null);
    }
