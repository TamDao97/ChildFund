...
public class DateUtils {
    ...
    public static String ConvertYMDServerToDMY(String date) {
        if (date == null || date.isEmpty() || date.equals(Constants.RESULT_STRING_NULL)) {
            return "";
        }
    ...
    public static String ConvertHmsServerToHm(String time) {
        if (time == null || time.isEmpty() || time.equals(Constants.RESULT_STRING_NULL)) {
            return "";
        }
     ...
     *
     * @param context
     * @param btnShowTimePicker
     * @param txtTime
     */
    public static void SetShowTimePicker(final Context context, ImageButton btnShowTimePicker, final EditText txtTime, final Boolean isRequired) {
    ...
    public static void dialogDatePicker(final EditText bt, Context context) {
