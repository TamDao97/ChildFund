...
public class BaoCaoDanTocAdapter extends RecyclerView.Adapter<BaoCaoDanTocAdapter.ViewHolder> {
    ...
    public BaoCaoDanTocAdapter(Context ctx, List<TuoiGioiTinhDanTocModel> items) {
        this.ctx = ctx;
    ...
    @Override
    public BaoCaoDanTocAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_bao_cao_dan_toc, parent, false);
        v.setBackgroundResource(mBackground);
        BaoCaoDanTocAdapter.ViewHolder vh = new BaoCaoDanTocAdapter.ViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(BaoCaoDanTocAdapter.ViewHolder holder, final int position) {
        ...
        holder.txtKinh.setText(tuoiGioiTinhDanTocModel.danTocKinh);
        holder.txtKhac.setText(tuoiGioiTinhDanTocModel.danTocKhac);
    }
